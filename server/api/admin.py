...
class BrandProfileAdmin(ColluneAdminMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        ("Brand Identity", {"classes": ("wide", "collune-section"), "fields": (("company_name", "industry"), ("logo", "website"), ("company_size", "linkedin_url"), ("about_brand",))}),
        ("Company Information", {"classes": ("wide", "collune-section"), "fields": (("gst_number", "cin_registration_number"), ("year_established",), ("headquarters_city", "headquarters_state", "headquarters_country"))}),
        ("Social Links", {"classes": ("wide", "collune-section"), "fields": (("instagram_url", "facebook_url"), ("x_url", "youtube_url"))}),
        ("Verification Documents", {"classes": ("wide", "collune-section"), "fields": (("gst_certificate", "pan_card"), ("company_registration_certificate",))}),
